...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:or,depthTest:!1,depthWrite:!1})}function Vg(){return new fi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Yu(),fragmentShader:`
		...
		`,blending:or,depthTest:!1,depthWrite:!1})}function Gg(){return new fi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Yu(),fragmentShader:`
		...
		`,blending:or,depthTest:!1,depthWrite:!1})}function Yu(){return`
	...
	`}var Xu=class extends hi{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},i=[n,n,n,n,n,n];this.texture=new Za(i),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Sb={[Of]:"Linear",[Ff]:"Reinhard",[Bf]:"Cineon",[al]:"ACESFilmic",[zf]:"AgX",[Vf]:"Neutral",[kf]:"Custom"};function bb(r,e){let t=Sb[e];return t===void 0?(Pe("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+r+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+r+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}var Wu=new k;function Tb(){tt.getLuminanceCoefficients(Wu);let r=Wu.x.toFixed(4),e=Wu.y.toFixed(4),t=Wu.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`].filter(vl).join(`
`)),o=fd(o),o=jg(o,t),o=Qg(o,t),a=fd(a),a=jg(a,t),a=Qg(a,t),o=e_(o),a=e_(a),t.isRawShaderMaterial!==!0&&(M=`#version 300 es
...
`)+`
`+g);let A=M+p+o,y=M+g+a,S=Kg(i,i.VERTEX_SHADER,A),E=Kg(i,i.FRAGMENT_SHADER,y);i.attachShader(_,S),i.attachShader(_,E),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.hasPositionAttribute===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function T(I){if(r.debug.checkShaderErrors){let P=i.getProgramInfoLog(_)||"",H=i.getShaderInfoLog(S)||"",z=i.getShaderInfoLog(E)||"",U=P.trim(),V=H.trim(),O=z.trim(),Z=!0,ee=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(Z=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,S,E);else{let L=$g(i,S,"vertex"),le=$g(i,E,"fragment");Ve("WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
